...
import com.banma.bpm.api.engine.AttachmentResponse;
import com.banma.bpm.api.engine.CommentResponse;
import com.banma.bpm.api.engine.EventResponse;
import com.banma.bpm.api.engine.RestIdentityLink;
import com.banma.bpm.api.engine.variable.QueryVariable;
import com.banma.bpm.api.engine.variable.RestVariable;
import com.banma.bpm.api.engine.variable.RestVariable.RestVariableScope;
import com.banma.bpm.api.form.FormDataResponse;
import com.banma.bpm.api.form.RestEnumFormProperty;
import com.banma.bpm.api.form.RestFormProperty;
import com.banma.bpm.api.history.HistoricActivityInstanceResponse;
import com.banma.bpm.api.history.HistoricDetailResponse;
import com.banma.bpm.api.history.HistoricIdentityLinkResponse;
import com.banma.bpm.api.history.HistoricProcessInstanceResponse;
import com.banma.bpm.api.history.HistoricTaskInstanceResponse;
import com.banma.bpm.api.history.HistoricVariableInstanceResponse;
import com.banma.bpm.api.identity.GroupResponse;
import com.banma.bpm.api.identity.MembershipResponse;
import com.banma.bpm.api.identity.UserInfoResponse;
import com.banma.bpm.api.identity.UserResponse;
import com.banma.bpm.api.management.JobResponse;
import com.banma.bpm.api.management.TableResponse;
import com.banma.bpm.api.repository.DecisionTableResponse;
import com.banma.bpm.api.repository.DeploymentResourceResponse;
import com.banma.bpm.api.repository.DeploymentResponse;
import com.banma.bpm.api.repository.FormDefinitionResponse;
import com.banma.bpm.api.repository.ModelResponse;
import com.banma.bpm.api.repository.ProcessDefinitionResponse;
import com.banma.bpm.api.runtime.process.EventSubscriptionResponse;
import com.banma.bpm.api.runtime.process.ExecutionResponse;
import com.banma.bpm.api.runtime.process.ProcessInstanceResponse;
import com.banma.bpm.api.runtime.task.TaskResponse;
