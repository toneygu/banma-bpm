...
package com.banma.bpm.api.runtime.process;
...
public class ProcessInstanceVariableResource extends BaseExecutionVariableResource {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "body", type = "com.banma.bpm.api.engine.variable.RestVariable", value = "Create a variable on a process instance", paramType = "body", example = "{\n" +
                    "    \"name\":\"intProcVar\"\n" +
                    "    \"type\":\"integer\"\n" +
                    "    \"value\":123,\n" +
                    " }"),
