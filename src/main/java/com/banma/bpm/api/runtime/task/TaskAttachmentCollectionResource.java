...
package com.banma.bpm.api.runtime.task;
...
import com.banma.bpm.api.engine.AttachmentRequest;
...
public class TaskAttachmentCollectionResource extends TaskBaseResource {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "body", type = "com.banma.bpm.api.engine.AttachmentRequest", value = "create an attachment containing a link to an external resource", paramType = "body", example = "{\n" + "  \"name\":\"Simple attachment\",\n" + "  \"description\":\"Simple attachment description\",\n"
